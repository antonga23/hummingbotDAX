...
cdef class ConnectorBase(NetworkIterator):
    ...
    def get_balance(self, currency: str) -> Decimal:
        ...
        """
        #print("curr!:", self._account_balances, "cur", currency) # PRINTY
        return self._account_balances.get(currency.lower(), s_decimal_0) # HACK: Had to make currency lowercase for Openware. This might break other exchanges.
