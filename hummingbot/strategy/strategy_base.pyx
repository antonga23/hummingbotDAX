...
cdef class StrategyBase(TimeIterator):
	...
	def balance_warning(self, market_trading_pair_tuples: List[MarketTradingPairTuple]) -> List[str]:
		...
		for market_trading_pair_tuple in market_trading_pair_tuples:
			...
			#print("base balance!:",base_balance, market_trading_pair_tuple.base_asset) # PRINTY
			#print("quote balance!:",quote_balance, market_trading_pair_tuple.quote_asset) # PRINTY
